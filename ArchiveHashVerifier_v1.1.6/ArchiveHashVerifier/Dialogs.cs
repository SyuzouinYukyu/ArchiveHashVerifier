...
public sealed class CompletionReport
{
    ...
    {
        string[] methods = ["SHA-512", "SHA-256", "SHA3-512", "SHA3-256", "BLAKE3", "ASC", "SIG"];
    ...
    public string ToPlainText()
    {
        ...
        foreach (string method in new[] { "SHA-512", "SHA-256", "SHA3-512", "SHA3-256", "BLAKE3", "ASC", "SIG" })
    ...
    private static string? Classify(string itemName)
    {
        ...
        if (itemName.Contains("BLAKE3", StringComparison.OrdinalIgnoreCase)) return "BLAKE3";
...
public sealed class CompletionDialog : Form
{
    ...
    private readonly TextBox resultText;
    ...
    public CompletionDialog(CompletionReport report, Font ownerFont)
    {
        ...
        resultText = new TextBox { Text = reportText, Multiline = true, ReadOnly = true, Dock = DockStyle.Fill,
        ...
        okButton = new Button { Text = "OK", AutoSize = true, DialogResult = DialogResult.OK };
        ...
        Shown += (_, _) => { resultText.SelectionStart = 0; resultText.SelectionLength = 0; ActiveControl = okButton; okButton.Focus(); };
    }
